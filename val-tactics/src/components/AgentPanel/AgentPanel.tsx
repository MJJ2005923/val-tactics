...
const nonDraggable = new Set(['sage-healing-orb', 'sage-resurrection', 'reyna-devour', 'reyna-dismiss', 'reyna-empress', 'clove-pick-me-up', 'clove-not-dead-yet', 'jett-blade-storm', 'neon-overdrive', 'iso-double-tap'])
